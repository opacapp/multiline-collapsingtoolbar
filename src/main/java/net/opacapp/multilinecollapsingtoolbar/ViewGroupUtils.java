...
class ViewGroupUtils {
    ...
    /**
     * This is a port of the common {@link ViewGroup#offsetDescendantRectToMyCoords(android.view
     * .View,
     ...
     * @param rect       (in/out) the rect to offset from descendant to this view's coordinate
     *                   system
     */
